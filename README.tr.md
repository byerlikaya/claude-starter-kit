...
![Sürüm](https://img.shields.io/badge/s%C3%BCr%C3%BCm-1.2.1-2563eb?style=flat-square)
...
- **30 skill** — "nasıl" sorusunun tek kaynağı, her alan için bir tane (tüm katalog aşağıda).
- **6 slash komut** — `/brainstorm` · `/plan` · `/review` · `/ship` · `/handoff` · `/simplify`.
...
<details>
<summary><b>Tüm skill kataloğu</b> — 30 skill, her birinden üretilir</summary>
...
> **Profil budaması token kazandırmaz.** `--backend` (10 ajan, 27 skill), `--fullstack`'ten (11 ajan, 30 skill) yalnızca ~640 token ucuz. Profili işin kapsamını daraltmak için seç.
