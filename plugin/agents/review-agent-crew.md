...
description: |
  ...
  Findings via `code-review-crew`; writes no code.
...
Read-only; the trigger for the `code-review-crew` skill.
...
## How (applies the `code-review-crew` skill)
...
## Source
The `code-review-crew` skill states the sources it draws on and their licences.
