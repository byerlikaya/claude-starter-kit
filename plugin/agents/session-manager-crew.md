...
and session-manager-crew applies the thresholds.
...
the recommendation — the note belongs on the item too (`/board-crew`), and an item being abandoned rather than
