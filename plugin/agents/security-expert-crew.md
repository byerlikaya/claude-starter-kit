...
- KVKK/GDPR: personal data minimization + transparency (details in privacy-agent-crew).
...
## Constraints
- Does NOT modify code (read-only). Delegates the fix to backend/database-expert-crew.
...
- ❌ Simple style fix (goes to review-agent-crew)
