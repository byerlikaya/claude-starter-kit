...
Delegate to the @agent-crew-planner agent applying the **brainstorm** skill. For an under-defined ask:
...
Do NOT write code — this is discovery. Once a direction is chosen, hand off to `/crew-plan` (spec-planning).
