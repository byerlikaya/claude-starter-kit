...
Delegate to the @agent-planner-crew agent applying the **brainstorm** skill. For an under-defined ask:
...
Do NOT write code — this is discovery. Once a direction is chosen, hand off to `/plan-crew` (spec-planning).
