---
name: plan-crew
description: Spec-first planning — break down ambiguously scoped work with planner-crew.
argument-hint: "[task/feature description]"
---
# /plan-crew
Argument: $ARGUMENTS

Delegate to the @agent-planner-crew agent (spec-planning skill). For ambiguously scoped work:
