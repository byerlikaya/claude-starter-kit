---
name: crew-plan
description: Spec-first planning — break down ambiguously scoped work with crew-planner.
...
Delegate to the @agent-crew-planner agent (spec-planning skill). For ambiguously scoped work:
